...
const loginUserFromDB = async (payload: ILoginData) => {
     ...
     if (!isExistUser.verified) {
          ...
          if (isExistUser.role === USER_ROLES.SALES && !isExistUser.verifiedByAdmin) {
               throw new AppError(StatusCodes.FORBIDDEN, 'Please verify your account by admin, then try to login again');
          }
