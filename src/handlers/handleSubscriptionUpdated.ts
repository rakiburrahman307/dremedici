          ...
          if (existingUser) {
               ...
               if (pricingPlan) {
                    ...
                    if (currentActiveSubscription) {
                         if (currentActiveSubscription?.packageId?.priceId !== pricingPlan.priceId) {
                         ...
                         if (deactivatedSubscription) {
                              await Subscription.findByIdAndUpdate(deactivatedSubscription._id, { status: 'active' }, { new: true });
                         }
                    }
               } else {
